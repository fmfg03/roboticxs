...
FEATURE_MODULES = (
    ...
    ("founder_feedback_capture", "app.founder_feedback_capture", False),
    ("feedback_ledger_tags", "app.feedback_ledger_tags", False),
    ("daily_loop_outcome_tracker", "app.daily_loop_outcome_tracker", False),
    ("suggestion_quality_tuning", "app.suggestion_quality_tuning", False),
        ("prep_quality_tuning", "app.prep_quality_tuning", False),
        ("draft_revision_loop", "app.draft_revision_loop", False),
        ("memory_correction_loop", "app.memory_correction_loop", False),
        ("pilot_metrics_snapshot", "app.pilot_metrics_snapshot", False),
        ("friendly_user_onboarding_pack", "app.friendly_user_onboarding_pack", False),
        ("founder_to_friendly_pilot_baseline", "app.founder_to_friendly_pilot_baseline", False),
        ...
        ("pilot_onboarding_runbook", "app.pilot_onboarding_runbook", False),
        ...
        ("friendly_pilot_launch_baseline", "app.friendly_pilot_launch_baseline", False),
        ("first_friendly_user_activation", "app.first_friendly_user_activation", False),
        ("pilot_review_session_pack", "app.pilot_review_session_pack", False),
        ("pilot_learning_queue", "app.pilot_learning_queue", False),
        ("paid_pilot_readiness_gate", "app.paid_pilot_readiness_gate", False),
    ...
    *,
    ...
    if output_format == "json":
        ...
        lines = [
            ...
            f"Roadmap: 95P-{status.roadmap_closed_through} CLOSED_COMMITTED",
        ...
        lines.extend(
            [
                ...
                "Founder Feedback Capture: available for local non-persistent feedback receipts only",
                "Feedback Ledger & Tags: available for local structured feedback retrieval only",
                "Daily Loop Outcome Tracker: available for local founder loop outcome receipts only",
                "Suggestion Quality Tuning: available for local feedback-based suggestion ranking only",
                "Prep Quality Tuning: available for local prep feedback tuning only",
                "Draft Revision Loop: available for local draft revision candidates only",
                "Memory Correction Loop: available for local memory correction receipts only",
                "Pilot Metrics Snapshot: available for local pilot metrics only",
                "Friendly User Onboarding Pack: available for local 1-3 user onboarding only",
                "Founder-to-Friendly Pilot Baseline: available for local controlled pilot baseline only",
                ...
                "Pilot Onboarding Runbook: available for local Day 0-Day 7 execution guidance only",
                ...
                "Friendly Pilot Launch Baseline: available for local controlled launch checks only",
                "First Friendly User Activation: available for local activation receipts only",
                "Pilot Review Session Pack: available for local pilot session review packs only",
                "Pilot Learning Queue: available for local prioritized pilot learnings only",
                "Paid Pilot Readiness Gate: available for local paid-pilot readiness decisions only",
