...
def build_default_skill_runtime_manifests() -> tuple[SkillRuntimeManifest, ...]:
    manifests = (
        _manifest(
            ...
            "Basic",
            "basic",
            ("/start", "/help", "/demo", "/pilot", "/pilot_metrics", "/friendly_onboarding", "/friendly_pilot", "/pilot_users", "/pilot_user", "/pilot_health", "/pilot_invite", "/pilot_consent", "/pilot_provision", "/pilot_allowlist", "/inbox", "/inbox_done", "/inbox_dismiss"),
