...
def build_default_skill_runtime_manifests() -> tuple[SkillRuntimeManifest, ...]:
    manifests = (
        _manifest(
            ...
            "Basic",
            "basic",
            ("/start", "/help", "/demo", "/pilot", "/inbox", "/inbox_done", "/inbox_dismiss"),
        ...
        _manifest(
            ...
            "Memory",
            "basic",
            ("/memory", "/memory_review", "/memory_pending", "/memory_limits", "/memory_approve", "/memory_reject", "/memory_edit", "/memory_forget", "/suggestion_memory"),
            ("READ", "CLASSIFY", "DRAFT"),
