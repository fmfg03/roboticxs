---
name: roboticxs-daily-brief
description: Draft a user-reviewed Routine template for a daily brief using approved sources and the 88P wake gate.
package: roboticxs-daily-brief
---

# Roboticxs Daily Brief Blueprint
...
{
  "name": "Daily Brief",
  "description": "Prepare a concise daily brief from user-approved sources.",
  "package": "roboticxs-daily-brief",
  "inputs": ["approved_sources", "brief_topics", "preferred_delivery_window"],
  ...
  "skill_binding": "roboticxs-daily-brief",
