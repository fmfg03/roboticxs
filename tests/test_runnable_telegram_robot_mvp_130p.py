...
def test_130p_start_from_authorized_owner_produces_deterministic_online_response():
    ...
    assert "Your private robot is online." in receipt.reply_text
...
def test_130p_status_from_authorized_owner_produces_deterministic_runtime_status():
    ...
    assert "Roadmap: 95P-155P closed, Memory Review Flow active" in receipt.reply_text
...
def test_130p_startup_report_is_deterministic():
    ...
    assert "Product menu: Today, Brief, Prep, Tasks, Memory, Setup Check" in report
