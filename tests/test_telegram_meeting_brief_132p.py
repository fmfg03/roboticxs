...
def test_132p_help_start_and_status_expose_brief_command():
    ...
    assert "Available commands: /help, /status, /miss, /brief, /memory, /memory_limits, /memory_pending." in start_reply
    assert "/brief command: enabled" in status_reply
    assert "roadmap state: 95P-136P closed, 136P runtime active" in status_reply
...
def test_132p_unknown_fallback_lists_brief_command():
    ...
    assert "Available commands: /start, /help, /status, /miss, /brief, /memory, /memory_limits, /memory_pending." in reply
