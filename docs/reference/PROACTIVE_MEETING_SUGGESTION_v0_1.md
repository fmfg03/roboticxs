...
138P is closed committed when the module, Telegram reply path, roadmap registry, and tests all assert the action-only boundary. 139P later added owner-requested suggested meeting brief rendering only, and 140P and later remain unauthorized.
