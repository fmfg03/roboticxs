...
The stage registry records the 100P closed committed state after remediation review and validation. 101P and later remain unauthorized. No stage is next eligible after 100P without explicit maintainer direction.
