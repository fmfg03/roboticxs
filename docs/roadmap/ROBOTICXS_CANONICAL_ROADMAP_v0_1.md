...
The stage registry records the 100P implemented-pending-review state. 101P and later remain unauthorized. No stage is next eligible after 100P without explicit maintainer direction.
