...
The stage registry records the 96P implemented pending review state. Stage 97P and later are not authorized. No stage is next eligible after 96P without explicit maintainer direction.
